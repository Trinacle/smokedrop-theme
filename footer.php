    ...
    <div class="footer-inner">
        <div class="foot-newsletter">
            ...
            <div class="news-form-wrap">
                <?php // Clean newsletter signup. Submits via our own AJAX endpoint,
                      // which stores into Forminator form 37676 via PHP API (bypasses
                      // Forminator's nonce verification issues). ?>
                <form class="news-form sdn-news" id="sdn-news-form" novalidate>
                    <input type="email" name="email" id="sdn-news-email" placeholder="Enter your email" required aria-label="Email address">
